 ...
 */
final class Version20200207105616 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bestelregel ADD ijsrecept_id INT NOT NULL, CHANGE betaald betaald VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bestelregel DROP ijsrecept_id, CHANGE betaald betaald VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
